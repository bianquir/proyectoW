<div class="d-flex flex-column h-100 sidebar-bg">
  <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
    <li class="nav-item">
      <a href="#" class="nav-link active py-3" aria-current="page" title="Chat" data-bs-toggle="tooltip" data-bs-placement="right">
        <i class="bi bi-chat-fill icon-style"></i>
      </a>
    </li>
    <li>
      <a href="#" class="nav-link link-dark py-3" title="Cargar" data-bs-toggle="tooltip" data-bs-placement="right">
